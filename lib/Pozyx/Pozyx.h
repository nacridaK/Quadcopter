...
public:
    ...
    PozyxClass(I2C_HandleTypeDef* Hi2c, uint32_t Timeout)
    {
        hi2c = Hi2c;
        timeout = Timeout;
    }
    ...
    * @retval #POZYX_FAILURE function failed.
    */
    int begin(int mode = MODE_POLLING,  int interrupts = POZYX_INT_MASK_ALL, int interrupt_pin = POZYX_INT_PIN0);
 ...
 */
    ...
    */
    ...
    // int saveAnchorSelection(int type, uint8_t registers[] = NULL, int num_registers = 0, uint16_t remote_id = NULL);
 ...
 */
    ...
    *
    */
    const char* getSystemError(uint16_t remote_id = NULL);
